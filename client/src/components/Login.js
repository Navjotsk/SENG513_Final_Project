    ...
    <div className="wrapper">
      ...
      <div className="card" id="signIn">
        ...
        <button
          ...
          style={
            isShown
              ? { backgroundColor: "#FFFFFF", color: "#41BBD9" }
              : { backgroundColor: "#41BBD9", color: "#FFFFFF" }
          }
        >
          LOGIN
        </button>
        ...
        {!isShown && (
          <div className="innerCard">
            <form className="loginForms" onSubmit={handleSubmit}>
              ...
              <button onClick={forgotClicked} className="forgetButton">
                Forgot Password?
              </button>
            </form>
          </div>
      ...
      <div className="card" id="forgotPassword">
        ...
        <label className="forgotDescription">
